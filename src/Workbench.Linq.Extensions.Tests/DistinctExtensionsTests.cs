...
namespace Workbench.Linq.Extensions.Tests
{
    public class DistinctExtensionsTests
    {
        ...
        public void ListagemComItensRepetidosComparecaoSimples()
        {
            ...
            {
                new PessoaFisica() { Nome = "Manoela Vyctoria", NomeMae = "Perinalda", CPF = "111.111.111-11" },
                new PessoaFisica() { Nome = "Maria", NomeMae = "Paula", CPF = "111.111.111-11" },
                new PessoaFisica() { Nome = "Bias de Oliveira", NomeMae = "Magna", CPF = "222.222.222-22" }
            };
